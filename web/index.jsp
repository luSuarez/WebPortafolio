						...
						<div class="inner">
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										<header>
											<h1>Realiza Estudios en el extranjero</h1>
											<p>Especializate en otro pais</p>
										</header>
										<p>Realiza cursos al extranjero en las diferentes espececialidades de tu carrera</p>
										<ul class="actions">
											<li><a href="#" class="button big">Mas Informacion</a></li>
										</ul>
									</div>
								...
								<section>
									...
									<div class="features">
										<article>
											<span></span>
											<div class="content">
												<h3>Gana conocimiento</h3>
												<p>Adquiere conocimiento en los mas grandes insititutos</p>
											</div>
										</article>
										<article>
											
											<div class="content">
												<h3>Obten Experiencia</h3>
												<p>Gana experiencia en el extrajero y conoce nuevos lugares</p>
											</div>
										</article>
										<article>
											...
											<div class="content">
												...
												<p>Ponte a prueba en los desafios que te enfrentaras en el viaje</p>
											</div>
										</article>
										<article>
											...
											<div class="content">
												...
												<p>Has amigos y aumenta tu red de contactos con las personas de diferentes paises que iran al curso</p>
											</div>
										</article>
									</div>
								</section>
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li><a href="CargarLogInFamilia">Familia Anfitriona</a></li>
											</ul>
										</li>
